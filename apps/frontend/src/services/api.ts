// Re-export types from the extracted types module for backward compatibility
export type {
  UserRole,
  AccountStatus,
  User,
...
// Re-export demo mode helper and HTTP client for backward compatibility
export { isDemoMode } from './httpClient';

import { isDemoMode } from './httpClient';
...
class ApiService {
  // Delegate token management and HTTP requests to the shared httpClient
