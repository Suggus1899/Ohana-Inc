...
const testUsers = [
  ...
  },
  {
    ...
    email: 'inquilino@residencias.com',
  ...
  try {
    ...
    const propertiesData = [
      {
        ...
        city: 'San Juan de los Morros', state: 'Guarico', zipCode: '2301', neighborhood: 'Centro',
        lat: 9.9108, lng: -67.3567,
      ...
      },
      {
        ...
        city: 'San Juan de los Morros', state: 'Guarico', zipCode: '2301', neighborhood: 'Universitaria',
        lat: 9.9080, lng: -67.3540,
      ...
      },
      {
        ...
        location: 'Urb. Los Samanes, San Juan de los Morros',
        address: 'Calle Principal, Casa 25',
        city: 'San Juan de los Morros', state: 'Guarico', zipCode: '2301', neighborhood: 'Los Samanes',
        lat: 9.9150, lng: -67.3600,
      ...
      },
      {
        ...
        description: 'Residencia con habitaciones individuales, areas comunes y comedor.',
        price: 180, priceType: 'monthly' as const,
        bedrooms: 1, bathrooms: 1, area: 25,
        type: 'Residencia', listingType: 'Alquiler', furnished: true,
        location: 'Zona Universitaria, San Juan de los Morros',
        address: 'Calle 5, Residencia El Estudiante',
        city: 'San Juan de los Morros', state: 'Guarico', zipCode: '2301', neighborhood: 'Universitaria',
        lat: 9.9095, lng: -67.3555,
    ...
    if (convCreated) {
      const msgs = [
        ...
        { conversationId: conv.id, senderId: propietario.id, content: 'Claro, te espero. La direccion es Calle 5, Residencia El Estudiante.' },
      ];
    ...
    const txsData = [
      ...
      },
      {
        ...
        paymentMethod: 'Pago Movil', paymentReference: 'PM-2026-042',
        paymentDate: new Date('2026-04-30'),
        expiresAt: new Date('2026-05-07'),
        notes: 'Primer mes - Residencia Estudiantil Premium',
    ...
    const kycData = [
      {
        ...
        nationality: 'Venezolana', faceMatchScore: 96.5, livenessScore: 98.2,
        ...
        level1Data: { phone: '+58 424-1234569', verified: true },
      ...
      },
      {
        ...
        nationality: 'Venezolana', attempts: 1, consentedAt: new Date('2026-04-10'),
        level1Data: { phone: '+58 424-1234570', verified: true },
      },
      {
