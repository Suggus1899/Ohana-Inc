...
import behaviorEventTypesMigration from "../migrations/20260712-add-behavior-event-types";
...
const migrations = [
  ...
  { name: "20260712_add_behavior_event_types", migration: behaviorEventTypesMigration },
...
async function migrate() {
  try {
    ...
    await runAllMigrations(migrations, "up");
